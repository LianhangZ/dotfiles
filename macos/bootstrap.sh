...
# brew install ncdu
install_and_log "ncdu" "ncdu.log" brew install ncdu
# brew install gh
install_and_log "gh" "install_gh.log" brew install gh
# brew install lazygit
install_and_log "lazygit" "install_lazygit.log" brew install lazygit
