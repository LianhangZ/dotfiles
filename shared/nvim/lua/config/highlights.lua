...
local function apply_highlights()
  ...
  set("GitSignsChange", { fg = colors.blue, bg = colors.bg })
  set("GitSignsChangedelete", { fg = colors.blue, bg = colors.bg })
  set("GitSignsStagedChange", { fg = colors.blue, bg = colors.bg })
  set("GitSignsStagedChangedelete", { fg = colors.blue, bg = colors.bg })
